...
//	    contactRepr.setParameters({ metalComplex: e.target.checked })
	...
	loadStructure("../testFiles/1caq_prep.pdb").then(function () {
	})

	//loadStructure("../testFiles/fda-having-reference_first2.sdf").then(function () {
	//})

	//loadStructure("../testFiles/protein_83c746ea20_prep.pdb").then(function () {
	//})
	
	loadStructure("../../../../session-files/l984u5a7g3vfepfv6f8babksj2/PROTEIN/1caq_prep.pdb").then(function () {
	})
