...
<html lang="en" >
	...
	<body ng-app="nglViewerProteinApp" ng-cloak>		
        	
		<div ng-controller="nglViewerProteinController" ng-init="init()">
		...
		<script type="text/javascript" src="../../../../../../js/external/angular.min.js"></script>        		
        	<script type="text/javascript" src="../controller/nglViewerProteinController.js"></script>
