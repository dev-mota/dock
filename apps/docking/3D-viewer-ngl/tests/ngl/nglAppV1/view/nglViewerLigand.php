...
<html lang="en" >
	...
	<body ng-app="nglViewerLigandApp" ng-cloak>		
        	
		<div ng-controller="nglViewerLigandController" ng-init="init()">
  	  					...
  	  					<li>
                            	<div class="dropdown">
                  				...
                  				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li ng-repeat="(folderKey, folderValue) in outputPaths"><a href="#" ng-click="loadNgl(folderKey, 0)">{{folderValue.inputNoExt}}</a></li>                                                                
                  				</ul>
                				</div>
            				</li>
            				<li><!-- Small empty column --></li>
		...
		<script type="text/javascript" src="../../../../../../js/external/angular.min.js"></script>        		
        	<script type="text/javascript" src="../controller/nglViewerLigandController.js"></script>
